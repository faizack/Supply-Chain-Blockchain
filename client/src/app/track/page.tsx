...
export default function Track() {
  ...
  const loadBlockchainData = async () => {
    try {
      ...
      const rmsCtr = await contract.methods.supplierCtr().call()
      ...
      const manCtr = await contract.methods.producerCtr().call()
      ...
      const disCtr = await contract.methods.distributorCtr().call()
      ...
      const retCtr = await contract.methods.sellerCtr().call()
    ...
    <DashboardPageShell heading="Track Materials" subheading="Traceability">
      <div className="mx-auto max-w-6xl">
          ...
          <div className="flex justify-between items-center mb-4">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground text-sm">Monitor your battery journey through the supply chain</p>
              </div>
            </div>
            <button
              onClick={() => router.push('/')}
        ...
        <Card className="mb-6 shadow-sm">
          <CardHeader>
            <CardTitle>Enter Battery ID to Track</CardTitle>
          </CardHeader>
          <CardContent>
            ...
            <Table>
              ...
              <TableBody>
                  {Object.keys(med).map((key) => {
                    ...
                    return (
                      <TableRow key={key} className="cursor-pointer" onClick={() => trackMedicine(medicineId)}>
                        <TableCell className="font-medium">
                          <div className="flex items-center">
                            <span className="font-semibold">{med[medicineId].id}</span>
                          </div>
                        </TableCell>
                        <TableCell>{med[medicineId].name}</TableCell>
                        <TableCell>{med[medicineId].description}</TableCell>
                        <TableCell>
